...
BATCH_SIZE = 20  # Pull 10 samples at a time
frame_count = 0
...
def get_eeg_sample(inlet):
    sample, timestamp = inlet.pull_sample()
    return sample[:4], timestamp  # Return only EEG channels
...
ax[0].set_ylim(-500, 500)  # y-axis: range of EEG amplitude (microvolts)
...
ax[2].set_ylim(-100000, 0)
ax[3].set_ylim(-100000, 0)
ax[4].set_ylim(-100000, 0)
ax[5].set_ylim(-100000, 0)
ax[6].set_ylim(-100000, 0)
